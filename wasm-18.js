...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'wasm-18.data';
      var REMOTE_PACKAGE_BASE = 'wasm-18.data';
  ...
  Module['FS_createPath']("/", "sprites", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_wasm-18.data');

      };
      Module['addRunDependency']('datafile_wasm-18.data');
   ...
   loadPackage({"files": [{"filename": "/sprites/Projectile.png", "start": 0, "end": 146, "audio": 0}], "remote_package_size": 146, "package_uuid": "7c1c7156-7c6e-4d8c-a62f-e7a2417e0f6b"});
...
var wasmBinaryFile = 'wasm-18.wasm';
